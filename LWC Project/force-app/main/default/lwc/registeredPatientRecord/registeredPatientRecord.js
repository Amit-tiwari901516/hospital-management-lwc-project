...
import fetchRegisteredPatientRecords from "@salesforce/apex/RecordClass.fetchRegisteredPatientRecords";

export default class RegisteredPatientRecord extends LightningElement {
    ...
    columns = [
     ...
     @wire(fetchRegisteredPatientRecords)
     wireDoc({ error, data }) {
         if (data) {
             data = JSON.parse(JSON.stringify(data));
             data.forEach(res => {
                 res.RegisterPatientLink = '/' + res.Id;
             });
